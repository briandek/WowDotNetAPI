...
namespace WowDotNetAPI.Test
{
    ...
    public class CharacterTests
    {
        ...
        public void Get_Simple_Character_Shirokuma_From_Skullcrusher_WithHunterPets()
        {
            ...
            var shirokuma = explorer.GetCharacter(Realm, "shirokuma", CharacterOptions.GetHunterPets);
        ...
        {
            var talasi = explorer.GetCharacter(Realm, "talasi", CharacterOptions.GetEverything);
